public class Main {
    public static void main(String[] args) {
        ...
        String[][] datos = {
                ...
                { "Donde viven los monstruos", "978877381501", "2800" },
        ...
        for (int i = 0; i < datos.length; i++) {
            ...
            int cantpag = Integer.parseInt(datos[i][2]);

            libros[i] = new Libro(titulo, isbn, cantpag);

            biblioteca.agregarL(libros[i]);
        }
        biblioteca.mostrarL();
        biblioteca.cantidadL();
    }
}