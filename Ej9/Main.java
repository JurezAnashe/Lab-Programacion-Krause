public class Main {
    public static void realizarSoundcheck(cantante cantante) throws Excepcion {
        if (cantante.getCantCanciones() < 5) {
            throw new Excepcion("Repertorio insuficiente. " + cantante.getNombre() + " solo tiene "
                    + cantante.getCantCanciones() + " canciones programadas.");
        }
